...
// one of the existing Survival Shooter scripts.
    ...
    public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        public static string removeAdsId = "removeads";
        ...
        public void InitializePurchasing() 
        {
            ...
            {
                builder.AddProduct(consumableID[i], ProductType.Consumable);
            }
            ...
            {
                builder.AddProduct(subscriptionID[i], ProductType.Subscription, new IDs(){
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
        {
            for (int i = 0; i < consumableID.Length; i++)
            {
                if (String.Equals(args.purchasedProduct.definition.id, consumableID[i], StringComparison.Ordinal))
                {
                    Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
                    GameDataController.instance.boughtNewMap = true;
                    UIController.instance.BuyNewMapSuccess();
            ...
            for (int i = 0; i < subscriptionID.Length; i++)
            {
                if (String.Equals(args.purchasedProduct.definition.id, subscriptionID[i], StringComparison.Ordinal))
                {
                    Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
                    // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.
                    return PurchaseProcessingResult.Complete;
